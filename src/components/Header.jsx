...
const Header = () => {
  ...
  return (
    ...
    <div className='flex items-center z-[1000] justify-between fixed rounded-full bg-black py-3 sm:py-5 px-10 w-[95%] sm:max-w-[75%] border-spacing-3 border-opacity-10 border border-grey ' >
