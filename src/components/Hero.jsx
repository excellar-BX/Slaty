...
const Hero = () => {
  ...
  return (
    <div className='mx-auto  sm:w-[70%] pt-20 sm:pt-40 bg-5 sm:pb-20 bg-image text-white '  >
      ...
      <div className='flex flex-wrap xl:text-6xl sm:text-4xl w-[90%] text-2xl justify-center items-center' >Are you a <span className='text-orange' > student? </span><span className='animate-spin ' > ✦ </span> Learn how you can use <span className='text-orange' > SLATY </span> to get better grades</div>
