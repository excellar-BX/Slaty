...
const Hero = () => {
  ...
  return (
    <div className='mx-auto  sm:w-[70%] pt-20 sm:pt-40 bg-5 sm:pb-20 bg-image text-white '  >
      ...
      <div className=' flex justify-center items-center sm:text-lg mt-10 text-white text-opacity-70 max-w-[90%] mx-auto w-fit text-center mx-auto '  >Join the waitlist today and recieve a free personalized study guide tailored to your academic needs</div>
      <Link to='/waitlist' >
